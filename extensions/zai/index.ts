...
import { fetchZaiUsage, resolveLegacyAgentAccessToken } from "openclaw/plugin-sdk/provider-usage";
  ...
  register(api) {
    api.registerProvider({
      ...
      resolveUsageAuth: async (ctx) => {
        ...
        const legacyToken = resolveLegacyAgentAccessToken(ctx.env, ["z-ai", "zai"]);
